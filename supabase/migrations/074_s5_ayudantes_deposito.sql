-- =============================================
-- 5S: Ranking de ayudantes de DEPÓSITO (bimestral)
-- - s5_ayudantes_config: fórmula editable (pesos + topes)
-- - s5_ayudantes_premios: ganadores persistidos por bimestre/área (editable)
-- Aplicar SOLO en la Supabase de Pampeana (dpo-app-self). La feature es
-- exclusiva de Pampeana; el código se gatea con IS_MISIONES para que en el
-- deploy compartido de Misiones nunca consulte estas tablas (no hace falta
-- crearlas allá).
-- =============================================
