...
//
// NO vive acá: el simulador ya existe en Costo por PDV > Simulación
// (simulacion-tab.tsx + getCostoPorPdvSim), con el desglose por componente y
// el delta contra el modelo real. Duplicarlo era garantizar que en algún
// momento los dos dieran distinto. La página de Plan Territorial muestra los
// supuestos del escenario (km por ciudad) y linkea a esa solapa.
//
// 🚨 Y hay un límite del modelo que ninguna de las dos puede saltear: la RPC
// parte de un pool de costo FIJO (costo_logistico_mensual) y lo reparte, así
// que cambiar los km redistribuye entre ciudades pero deja el total idéntico.
// Verificado sobre jun-2026: $175.769.947 y 27.307 $/HL en ambos escenarios.
// ==================================================================
