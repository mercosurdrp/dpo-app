...
export const ARBOL_SUENO: SuenoNodoConfig[] = [
  ...
  { key: "otif", label: "OTIF", nivel: "estrategia", rama: "cliente", parentKey: null, unidad: "%", mejorSi: "mayor", metaDefault: 98 },
  ...
  { key: "in_full", label: "IN-FULL", nivel: "gestion", rama: "cliente", parentKey: "otif", unidad: "%", mejorSi: "mayor", metaDefault: 99 },
