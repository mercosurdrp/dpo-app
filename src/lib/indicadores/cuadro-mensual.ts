...
export const INDICADORES: IndicadorDef[] = [
  ...
  { id: "ocupacion_bodega", pilar: "Entrega", nombre: "Ocupación de bodega", unidad: "%", meta: 41.7, mejor_si: "mayor", resumen: "promedio", nota: "Cuánto del camión se llenó: CEq promedio por viaje sobre los 1.440 CEq que entran en la bodega. La meta 41,7% son los 600 CEq de carga mínima por viaje." },
