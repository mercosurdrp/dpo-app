...
export const INDICADORES: IndicadorDef[] = [
  ...
  { id: "ocupacion_bodega", pilar: "Entrega", nombre: "Ocupación de bodega", unidad: "%", meta: 100, mejor_si: "mayor", resumen: "promedio", nota: "Cumplimiento del objetivo de carga: CEq promedio por viaje sobre los 600 CEq objetivo. El 100% es el objetivo alcanzado. La ocupación física del camión (sobre los 1.440 CEq de bodega) se ve en el detalle de Ocupación de Bodega." },
  { id: "segundas_vueltas", pilar: "Entrega", nombre: "Segundas vueltas", unidad: "viajes", meta: null, mejor_si: "menor", resumen: "suma", nota: "Viajes de segunda vuelta del mes: el camión vuelve a salir después de descargar. CARGA MANUAL — Chess no pone patente en los comprobantes de SEGUNDA VUELTA, así que no se pueden contar desde el sistema." },
  ...
  { id: "facturado_chess_bultos", pilar: "Ventas", nombre: "Bultos vendidos", unidad: "bultos", meta: null, mejor_si: "sin", resumen: "suma", nota: "Total facturado en Chess (sistema madre), neto: Factura + Factura Presupuesto − Notas de Crédito − Devoluciones Presupuesto. No incluye el reparto propio." },
  { id: "facturado_chess_hl", pilar: "Ventas", nombre: "HL vendidos", unidad: "HL", meta: null, mejor_si: "sin", resumen: "suma", nota: "Hectolitros netos facturados en Chess: Factura + Factura Presupuesto − Notas de Crédito − Devoluciones Presupuesto. No incluye el reparto propio." },
  { id: "facturado_chess_ceq", pilar: "Ventas", nombre: "CEq vendidas", unidad: "CEq", meta: null, mejor_si: "sin", resumen: "suma", nota: "Cajas equivalentes netas facturadas en Chess (bultos × factor CEq = 120/bultos_pallet): Factura + Factura Presupuesto − Notas de Crédito − Devoluciones Presupuesto. No incluye el reparto propio." },
