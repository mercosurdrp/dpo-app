  ...
  return (
    <Card>
      ...
      <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <NumField label="Vol PICO (HL)" value={vol_pico} onChange={setVP} step={50} min={0} max={5000} />
        <NumField label="Vol ALTO (HL)" value={vol_alto} onChange={setVA} step={50} min={0} max={5000} />
        <NumField label="Vol MEDIO (HL)" value={vol_medio} onChange={setVM} step={50} min={0} max={5000} />
