...
export function IniciativaFormDialog({
  ...
  const [area, setArea] = useState<AreaIniciativaAhorro | "">(
    iniciativa?.area ?? "",
  )

  useEffect(() => {
    // Reset del formulario al abrir / cambiar la iniciativa editada.
    if (open) {
      ...
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Select
                value={area}
                onValueChange={(v: string | null) =>
                  setArea((v as AreaIniciativaAhorro) ?? "")
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-1.5">
              <Label htmlFor="nivel_impacto">Nivel de impacto (%)</Label>
              <Input
                id="nivel_impacto"
                name="nivel_impacto"
                type="number"
                ...
                max="100"
                step="1"
                defaultValue={iniciativa?.nivel_impacto ?? ""}
                placeholder="0–100"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="inversion_capex">Inversión / CAPEX ($)</Label>
              <Input
                id="inversion_capex"
                name="inversion_capex"
                type="number"
                step="0.01"
                defaultValue={iniciativa?.inversion_capex ?? ""}
                placeholder="0"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              name="acciones_clave"
              rows={2}
              defaultValue={iniciativa?.acciones_clave ?? ""}
              placeholder="Acciones necesarias para la ejecución (internas / externas)"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              name="justificacion"
              rows={2}
              defaultValue={iniciativa?.justificacion ?? ""}
              placeholder="Por qué conviene la iniciativa (impacto económico / servicio)"
            />
          </div>
